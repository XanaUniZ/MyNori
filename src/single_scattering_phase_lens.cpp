...
class SingleScatteringPhaseLens : public Integrator {
public:
    SingleScatteringPhaseLens(const PropertyList& props) {
...
NORI_REGISTER_CLASS(SingleScatteringPhaseLens, "single_scattering_phase_lens");
